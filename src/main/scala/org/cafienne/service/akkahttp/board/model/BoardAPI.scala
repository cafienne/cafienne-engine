...
object BoardAPI {
  ...
  case class BoardResponseFormat(id: String, title: Option[String], team: BoardTeamAPI.BoardTeam, columns: Seq[Column]) extends CafienneJson {
    override def toValue: Value[_] = new ValueMap(Fields.id, id, Fields.title, title, Fields.team, team, Fields.columns, columns)
  }

  object Examples {
    case class BoardResponse(id: String, title: Option[String], team: BoardTeamAPI.BoardTeam, columns: Seq[ColumnExample])
