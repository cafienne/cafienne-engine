...
object FlowAPI {
  ...
  implicit val completeFlowTaskFormatReader: EntityReader[CompleteFlowTaskFormat] = entityReader[CompleteFlowTaskFormat]
  ...
  case class CompleteFlowTaskFormat(subject: String, data: ValueMap)
}
