...
import org.cafienne.board.actorapi.command.team.AddTeamRole;
import org.cafienne.board.actorapi.command.team.RemoveMember;
import org.cafienne.board.actorapi.command.team.RemoveTeamRole;
...
import org.cafienne.board.actorapi.event.team.BoardTeamRoleAdded;
import org.cafienne.board.actorapi.event.team.BoardTeamRoleRemoved;
...
public class BoardSerializers {
    ...
    private static void addBoardCommands() {
        ...
        CafienneSerializer.addManifestWrapper(AddTeamRole.class, AddTeamRole::deserialize);
        CafienneSerializer.addManifestWrapper(RemoveTeamRole.class, RemoveTeamRole::deserialize);
    }
    ...
    private static void addBoardEvents() {
        ...
        CafienneSerializer.addManifestWrapper(BoardTeamRoleAdded.class, BoardTeamRoleAdded::new);
        CafienneSerializer.addManifestWrapper(BoardTeamRoleRemoved.class, BoardTeamRoleRemoved::new);
