...
object Deps {
  ...
  val joseJwt               = "com.nimbusds"            % "nimbus-jose-jwt"                       % "9.10.1"
  ...
  val swaggerAkkaHttp       = "com.github.swagger-akka-http" %% "swagger-akka-http"               % "2.4.2"
  ...
  val junit                 = "org.junit.jupiter"       % "junit-jupiter-api"                     % "5.7.2"
  ...
  val spel                  = "org.springframework"     %  "spring-expression"                    % "5.3.8"
  val jsonPath              = "com.jayway.jsonpath"  	  % "json-path"                             % "2.6.0"

  val javaMail              = "com.sun.mail"            % "javax.mail"                            % "1.6.2"
  val ical4j                = "org.mnode.ical4j"        % "ical4j"                                % "3.0.27"
  ...
  val sw4jj                 = "com.github.j5ik2o"       %% "sw4jj"                                % "1.1.48"
