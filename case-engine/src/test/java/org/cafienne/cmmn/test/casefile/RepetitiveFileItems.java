...
public class RepetitiveFileItems {
    ...
    public void testRepetitiveFileItems() {
        ...
        testCase.addStep(new CreateCaseFileItem(testUser, caseInstanceId, topPath, topCaseObject.cloneValueNode()), casePlan -> {
            casePlan.print();
        ...
        testCase.addStep(new CreateCaseFileItem(testUser, caseInstanceId, itemsPath, itemArray.cloneValueNode()), casePlan -> {
            casePlan.print();
        ...
        testCase.addStep(new CreateCaseFileItem(testUser, caseInstanceId, itemsPath, itemObject.cloneValueNode()), casePlan -> {
            casePlan.print();
