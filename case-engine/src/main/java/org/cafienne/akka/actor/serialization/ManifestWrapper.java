...
class ManifestWrapper {
     ...
     */
    final ValueMapDeserializer<?> deserializer;
    /**
     ...
     */
    final String[] manifestsByVersion;

    ManifestWrapper(Class<?> eventClass, ValueMapDeserializer<?> deserializer) {
        if (eventClass == null) {
     ...
     * @return
     */
    ValueMap migrate(ValueMap original, String olderVersionManifest) {
