...
class CaseQueriesImplTest extends TestKit(ActorSystem("testsystem", TestConfig.config)) with FlatSpecLike with MustMatchers with BeforeAndAfterAll with DbConfig {
