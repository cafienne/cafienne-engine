...
import org.cafienne.service.db.query.exception.{ConsentGroupMemberSearchFailure, ConsentGroupSearchFailure, TenantSearchFailure, UserSearchFailure}
import org.cafienne.service.db.record.{ConsentGroupMemberRecord, TenantRecord, UserRoleRecord}
import org.cafienne.service.db.schema.table.{ConsentGroupTables, TenantTables}
