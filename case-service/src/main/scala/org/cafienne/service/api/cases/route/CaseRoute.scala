        ...
        post {
          entity(as[StartCaseFormat]) { payload =>
            try {
              ...
              askCaseWithValidTeam(tenantUser, caseTeam.members, tenantUser => new StartCase(tenant, tenantUser, newCaseId, caseDefinition, inputParameters, caseTeam, debugMode))
            } catch {
