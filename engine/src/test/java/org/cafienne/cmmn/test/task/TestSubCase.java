...
public class TestSubCase {
    ...
    public void testSubCase() {
         ...
         */
        testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId, "Task1", Transition.Complete), mainCasePlan ->
        {
            mainCasePlan.print();
            ...
            testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId, "SubCaseTask", Transition.Suspend), result ->
            {
            ...
            testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId, "SubCaseTask", Transition.Resume), result ->
            {
            ...
            testCase.addStep(new MakePlanItemTransition(testUser, subCaseId, caseInstanceId, "Item1", Transition.Complete), completeAction -> {
             ...
             */
            testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId, "NonBlockingSubCaseTask", Transition.Suspend), suspendedMainCase -> {
             ...
             */
            testCase.addStep(new MakePlanItemTransition(testUser, nonBlockingSubCaseId, caseInstanceId, "Item1", Transition.Suspend), nonBlockingSubCasePlan -> {
                TestScript.debugMessage("resulting non-blocking sub case: " + nonBlockingSubCasePlan);
             ...
             */
            testCase.addStep(new MakePlanItemTransition(testUser, nonBlockingSubCaseId, caseInstanceId, "Item1", Transition.Resume), resumeSubCasePlan -> {
             ...
             */
            testCase.addStep(new MakePlanItemTransition(testUser, nonBlockingSubCaseId, caseInstanceId, "Item1", Transition.Complete), completedSubCasePlan -> {
    ...
    public void testSubCaseTermination() {
        ...
        testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId, "Task1", Transition.Complete), mainCasePlan ->
        {
            ...
            testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId, "SubCaseTask", Transition.Terminate), result ->
            {
    ...
    public void testFailingSubCase() {
        ...
        testCase.addStep(new CreateCaseFileItem(testUser, caseInstanceId, caseInstanceId, invalidMainRequest, new Path("InvalidMainRequest")), action -> action.print());

        testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId,"TriggerFailingBlockingSubCaseTask", Transition.Complete), mainCasePlan -> {
            ...
            testCase.addStep(new UpdateCaseFileItem(testUser, caseInstanceId, caseInstanceId, validMainRequest, new Path("InvalidMainRequest")), r -> r.print()); // print the updated case file

            testCase.addStep(new MakePlanItemTransition(testUser, caseInstanceId, caseInstanceId,"FailingBlockingSubCaseTask", Transition.Reactivate), r -> {
