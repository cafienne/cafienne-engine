...
import org.cafienne.engine.cmmn.actorapi.event.team.deprecated.member.{CaseOwnerAdded, CaseOwnerRemoved, TeamRoleCleared, TeamRoleFilled}
import org.cafienne.engine.cmmn.actorapi.event.team.deprecated.user.{TeamMemberAdded, TeamMemberRemoved}
import org.cafienne.engine.cmmn.definition.team.CaseRoleDefinition
import org.cafienne.engine.cmmn.instance.team.{MemberType, Team}
