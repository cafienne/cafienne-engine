...
import org.cafienne.engine.cmmn.definition.casefile.CaseFileItemDefinitionDefinition;
...
public abstract class XMLElementDefinition implements DefinitionElement {
    ...
    protected String parseExpressionString(String childTagName, boolean presenceRequired, String... defaultValue) {
        String expression = parseString(childTagName, presenceRequired, defaultValue);
        if (expression != null) {
            expression = expression.replace("T(org.cafienne.cmmn", "T(org.cafienne.engine.cmmn");
        }
        return expression;
    }
    ...
    protected <T> T getCustomImplementation(Class<? extends T> typeClass, boolean presenceRequired) {
        ...
        String implementationClassName = implementationElement.getAttribute("class").replace("org.cafienne.processtask", "org.cafienne.engine.processtask");
