...
object H2EventDBSchema extends EventDBSchema {
  override def scripts(tablePrefix: String): Seq[SchemaMigrator] = Seq(new V1_1_13__AddTimerService(tablePrefix), new V1_1_16__CreateAkkaSchema(tablePrefix), new V1_1_36__ChangeTimerTablesAddRootCaseId(tablePrefix))
}
