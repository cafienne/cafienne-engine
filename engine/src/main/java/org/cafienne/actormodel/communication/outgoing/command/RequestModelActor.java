package org.cafienne.actormodel.communication.outgoing.command;

import com.fasterxml.jackson.core.JsonGenerator;
import org.cafienne.actormodel.ModelActor;
import org.cafienne.actormodel.command.BootstrapMessage;
import org.cafienne.actormodel.command.ModelCommand;
import org.cafienne.actormodel.communication.ModelActorSystemCommand;
...
@Manifest
public class RequestModelActor extends ModelActorSystemCommand implements BootstrapMessage {
    public final boolean debugMode; // TODO: check whether this is in use
    ...
    public void process(ModelActor actor) {
        this.actor.addEvent(new ActorRequestStored(this));
    }
