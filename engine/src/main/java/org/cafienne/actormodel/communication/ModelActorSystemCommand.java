...
public abstract class ModelActorSystemCommand extends BaseModelCommand<ModelActor, UserIdentity> implements ModelActorSystemMessage {
    public final ModelCommand command;

    protected ModelActorSystemCommand(ModelCommand command) {
        super(command.getUser(), command.actorId());
        this.command = command;
    }

    protected ModelActorSystemCommand(ValueMap json) {
        super(json);
