 ...
 */
public abstract class ModelActorSystemResponse extends ModelActorSystemCommand implements ModelResponse {
    private Instant lastModified;
    protected ModelActorSystemResponse(ModelCommand command) {
        super(command);
        this.lastModified = command.getActor() != null ? command.getActor().getLastModified() : null;
    }

    protected ModelActorSystemResponse(ValueMap json) {
        super(json);
